        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-icon rotate-n-15">
                    <i class="fas fa-home"></i> <!-- Ganti ikon dengan rumah (kost) -->
                </div>
                <div class="sidebar-brand-text mx-3">KostKita <span class="text-primary"></span></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <i class="fas fa-fw fa-home"></i> <!-- Ikon rumah/kost -->
                    <span>Kost</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">menu kost</h6>
                        <a class="collapse-item" href="{{ route('kost.index') }}">
                            <i class="fas fa-home mr-2"></i> Detail Kost
                        </a>
                        <a class="collapse-item" href="{{ route('kamar.index') }}">
                            <i class="fas fa-door-open mr-2"></i> Detail Kamar
                        </a>
                    </div>
                </div>
            </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    ...
                                    <p>{{ Auth::guard('pemilik')->user()->nama }}</p>
                                    @endif
                                </span>
                                <i class="fas fa-user-circle fa-lg text-muted rounded-circle" style="font-size: 2rem;"></i>
                            </a>
    ...
    <script>
        $(document).ready(function() {
            $('.status-select').change(function() {
                ...
                $.ajax({
                    url: '/kamar/update-status/' + kamarId,
                    type: 'POST',
                    data: {
                        status_kamar: status,
                        _token: '{{ csrf_token() }}'
                    ...
                    success: function(response) {
                        // Tampilkan pesan dari controller pakai SweetAlert
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
